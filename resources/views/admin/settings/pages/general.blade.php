                ...
                <div class="card-body">
                    <form action="{{ route('settings.system.update') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-6">
                                <div class="form-group">
                                    <label class="" for="shipping_cost_in_city"> {{ __('Shipping Cost') }} <small>(Insite City)</small></label>
                                    <input value="{{ $setting->shipping_cost_in_city }}" name="shipping_cost_in_city" type="text"
                                        class="form-control " placeholder="{{ __('Shipping Cost In City') }}">
                                </div>
                            </div> --}}
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="" for="shipping_charge"> {{ __('Shipping Charge') }}</small></label>
                                    <input value="{{ $setting->shipping_charge }}" name="shipping_charge" type="text"
                                        class="form-control " placeholder="{{ __('Shipping Charge') }}">
                                </div>
                            </div>
