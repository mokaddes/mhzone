...
<html>
<head>
    <title>You have a new query from ertho</title>
</head>
<body>
                ...
                <td width="100%" align="center" valign="top" bgcolor="#E4E6E9" style="background-color:#E4E6E9; min-height: 200px;">
                    <table>
                        <table class="header-row" width="378" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed; text-align: center; margin-bottom: 5px; margin-top: 30px; margin-left: 150px;">
                            <tbody>
                                <tr>
                                    <td class="header-row-td" style="font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #2D3748; margin: 0px; font-size: 25px; padding-bottom: 10px; text-aling: center; margin-left: 100px;" valign="top" align="left"> Ertho </td>
                                </tr>
                            </tbody>
                        </table>
                        <tbody>
