...
class CmsSettingController extends Controller
{
    ...
    public function updateAbout(Request $request)
    {
        ...
        $data = $request->only(['about_body', 'about_title', 'mission_title', 'mission_body', 'vission_title', 'vission_body', 'core_value_title', 'core_value_body', 'purpose_title' ,'purpose_body']);
